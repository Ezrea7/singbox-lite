...
```
(curl -LfsS https://raw.githubusercontent.com/Ezrea7/singbox-lite/refs/heads/main/singbox.sh -o /usr/local/bin/sb || wget -q https://raw.githubusercontent.com/Ezrea7/singbox-lite/refs/heads/main/singbox.sh -O /usr/local/bin/sb) && chmod +x /usr/local/bin/sb && sb
```
## **使用方法**
